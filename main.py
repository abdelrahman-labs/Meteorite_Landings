...
if page == 'Home':
    ...
    st.markdown(f"<h1><a href='{link}'>To view the project, click here</a></h1>", unsafe_allow_html=True)
    if st.button('View Project 3'):
        # Redirect to the project link
        st.experimental_set_query_params(project='3')
        project_link = 'https://abdelrahman-labs-shipping-quality-control-main-sh8g9x.streamlit.app/'
        st.experimental_rerun()
        st.markdown(f'<meta http-equiv="refresh" content="0;URL={project_link}">', unsafe_allow_html=True)
